...
export class PlannerComponent implements OnInit {
  ...
  tabColor(tab: number) {
    return tab == this.tabSelected
      ? 'border-slate-400 dark:border-slate-500 hover:bg-slate-200 bg-slate-100 dark:bg-slate-800'
      : 'border-slate-300 dark:border-slate-600 hover:bg-slate-100 bg-white';
  }
